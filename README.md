...
<img src="https://capsule-render.vercel.app/api?type=waving&color=gradient&customColorList=6,11,20&height=150&section=header&text=Fathima%20Marva%20KT&fontSize=42&fontColor=fff&animation=twinkling&fontAlignY=38&desc=Python%20Full%20Stack%20Developer&descAlignY=58&descSize=18" />

<img src="https://readme-typing-svg.demolab.com?font=Fira+Code&weight=600&size=22&pause=1000&color=58A6FF&center=true&vCenter=true&width=650&lines=Django+%7C+FastAPI+%7C+React;Building+Scalable+%26+AI-Powered+Apps;Open+to+Full+Stack+Developer+Roles+%F0%9F%9A%80" alt="Typing SVG" />
...
Hi, I'm **Fathima Marva KT** — a passionate **Python Full Stack Developer** from Kerala, India. 🇮🇳

I specialize in designing and building **production-ready web applications** — from clean, scalable REST APIs to responsive frontends. I have hands-on experience with **Django, FastAPI, and React**, and I enjoy taking full ownership of a product: from database architecture to user interface.

I've also worked with **AI/ML tooling** including **LangChain, LangGraph, FAISS, and RAG pipelines**, building intelligent systems like automated resume analyzers and mental health platforms.

- 🌱 Currently deepening expertise in **microservices, cloud architecture & AI integration**
- 💬 Ask me about **Django, FastAPI, React, or Python**
